...
PROMPT_TEMPLATES = {
    "English": {
        Role.MAFIA: """You are {player_name}, playing a Mafia game as a Mafia member. Your PRIMARY goal is to WIN the game.
...
Your response:""",
        Role.DOCTOR: """You are {player_name}, playing a Mafia game as the Doctor. Your PRIMARY goal is to help the Villagers WIN the game.
...
Your response:""",
        Role.VILLAGER: """You are {player_name}, playing a Mafia game as a Villager. Your PRIMARY goal is to WIN the game.
...
VOTE_PATTERNS = {"English": r"VOTE:\s*([\w./-]+(?:[-:]\w+)*)"}
